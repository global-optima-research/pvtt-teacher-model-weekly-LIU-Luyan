...
![breakdance comparison](issue1_img_comparison/breakdance_comparison.png)
...
![loading comparison](issue1_img_comparison/loading_comparison.png)

**Case 3: `dance-twirl` (SAM2: 0.958 vs Cutie: 0.904, Δ=0.054)**
- 旋转导致目标外观变化大
- SAM2 对外观变化的适应能力更强

![dance-twirl comparison](issue1_img_comparison/dance-twirl_comparison.png)

**Case 4: `motocross-jump` (SAM2: 0.919 vs XMem: 0.815, Δ=0.104)**
- 所有模型中差异最大的视频之一
- 快速运动 + 多目标 + 遮挡，SAM2 明显优于传统 VOS 模型

![motocross-jump comparison](issue1_img_comparison/motocross-jump_comparison.png)
...
![paragliding-launch comparison](issue1_img_comparison/paragliding-launch_comparison.png)

**Case: `lab-coat` (最高仅 0.695, XMem)**
- 有趣的是，XMem 在此视频上反而略优于 SAM2
- 可能涉及白色物体在白色背景下的分割困难

![lab-coat comparison](issue1_img_comparison/lab-coat_comparison.png)

**Case: `kite-surf` (最高仅 0.724, SAM2)**
- 远距离小目标 + 海面反光
- 所有模型均受到小目标检测的挑战

![kite-surf comparison](issue1_img_comparison/kite-surf_comparison.png)
...
![blackswan comparison](issue1_img_comparison/blackswan_comparison.png)
